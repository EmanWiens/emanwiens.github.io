...
//         <img src={rert_img} className="pannelItem" />
//       </div>
//     </div>
//   ); 
// }
  ...
  return (
    <div className="banner">
      <div className="buttonHolder">
        <a href="/About"><button type="button" className="headerBtn">About</button></a>
        <a href="/Projects"><button type="button" className="headerBtn">Projects</button></a>
        <a href="/Home"><button type="button" className="headerBtn">Home</button></a>
        <a href="/Home"><h1 className="name">Emanuel Wiens</h1></a>
      </div>
    </div>
  );
}
...
function make_projects() {
    ...
    <div className="contentPannel">
            ...
            <div className="pannelItem">
                <div className="itemRight">
                    <img src="proj1.gif" className="pannelItem" alt="" /> 
                </div>
                <h2>Welcome!</h2>
                <hr></hr>
                <div>
 ...
 certain details. However, there are many projects that I am proud to show off and there are always some more to add. If the code is public a link will be presented.</p>
            ...
            <div className="pannelItem">
                ...
                <div className="itemLeft">
                    <img src="RERT.gif" className="pannelItem" alt="Rapid Exploring Random Trees gif" />
                </div>
            </div> 
            ...
            <div className="pannelItem">
                <div className="itemRight">
                    <img src="ACO.gif" className="pannelItem" alt="Ant Colony Optimization gif" />
                </div>
            ...
            <div className="pannelItem">
                ...
                <div className="itemLeft">
                    <img src="LeastSquareRegression.png" className="pannelItem" alt="Least square regression gif"/>
                </div>
            </div> 
            ...
            <div className="pannelItem">
                <div className="itemRight">
                    <img src="savingyourbacon.png" className="pannelItem" alt=""/>
                </div>
            ...
            <div className="pannelItem">
                ...
                <div className="itemLeft">
                    <img src="Bloch_sphere.svg" className="pannelItem" alt="" />
                </div>
            </div> 
            ...
            <div className="pannelItem">
                <div className="itemRight">
                    <img src="planetColonizer.gif" className="pannelItem" alt="" />
                </div>
            ...
            <div className="pannelItem">
                ...
                <div className="itemLeft">
                    <img src="hackmaster.jpg" className="pannelItem" alt="" />
                </div>
            </div> 
            ...
            <div className="pannelItem">
                <div className="itemRight">
                    <img src="particleSystem.gif" className="pannelItem" alt="" />
                </div>
            ...
            <div className="pannelItem">
                ...
                <div className="itemLeft">
                    <img src="environEngine.gif" className="pannelItem" alt="" />
                </div>
            </div>
          </div> 
